...
function App() {
  ...
  return (    
    ...
    <div className='portaCard'>
      ...
      <Cards stock={3} initial="0" onAdd={onAdd} cardImg="https://media.querol.net/149146-home_default/zapatillas-lona-converse-chuck-taylor-all-star-lift-high-top-white.jpg"/>
